...
export const COMPONENTS: Record<string, ComponentInfo> = {
  ...
  pcb: {
    ...
    description: "Conçu en interne autour du microcontrôleur RP2040 de Raspberry Pi. Le PCB intègre les 12 emplacements MX, 4 potentiomètres ALPS et l'interface USB-C en un circuit compact 4 couches.",
    specs: [
      ...
      { label: "Couches PCB", value: "4 couches FR4" },
    ],
    color: "#059669",
  },
  switches: {
    ...
    description: "Les switches Cherry MX offrent un retour tactile précis et une durabilité de 100 millions de frappes. Disponibles en version Red (linéaire) ou Brown (tactile) selon ta préférence.",
    specs: [
